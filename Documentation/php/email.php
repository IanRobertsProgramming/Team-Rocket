<?php 
    ...
    require '/rocket/php/PHPMailer-master/src/Exception.php';
    require '/rocket/php/PHPMailer-master/src/PHPMailer.php';
    require '/rocket/php/PHPMailer-master/src/SMTP.php';
